# Goopify
<p align="center">
<img src="https://github.com/user-attachments/assets/0fb68d87-5b0d-47f6-8465-a3ccf5760557" text-align="center" width="80%" />
</p>
...
* Create Goopmaps for your levels
	...
	* An undo/redo system for positioning and painting
...
<p align="center">
<img src="https://github.com/user-attachments/assets/89f6d0f6-541d-47d6-89fa-2effecc237b1" text-align="center" width="48%" />
</p>

Once you're done with this step, you can then click "Finish" to export your custom goop into a level. Note that you will have to select an extracted level folder (aka not a SZS file). You level will now have everything it needs to work with goop, no extra setup is needed.
<p align="center">
<img src="https://github.com/user-attachments/assets/1d16e241-7556-466c-97b2-a0c04f64c2a4" text-align="center" width="48%" />
</p>

Congrats, you now have custom goop in your level! At any point in the editor you can save your custom goopmap using File->Save or by using the hotkey "Ctrl+S"
